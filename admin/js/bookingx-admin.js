...
jQuery(document).ready(function () {
    ...
    //mm/dd/yy
    jQuery("#id_biz_vac_sd").datepicker({dateFormat: bkx_admin.wp_date_format});
    ...
    jQuery("#id_biz_vac_ed").datepicker({dateFormat: bkx_admin.wp_date_format});

    jQuery("#id_biz_ph_1").datepicker({dateFormat: bkx_admin.wp_date_format});
...
function add_more_ph() {
    ...
    jQuery("#id_clone_ph_" + set_next_val).datepicker({dateFormat: bkx_admin.wp_date_format});
