 ...
 * @see https://developer.wordpress.org/block-editor/reference-guides/block-api/block-registration/
 */
registerBlockType( 'booking-x/bkx-booking-form', {
	title: 'Booking X Booking Form', // Block name visible to user
	icon : <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 124 124"
		...
		<path className="cls-1"
			  d="M96.6,101.72H27.4a8.66,8.66,0,0,1-8.65-8.65V35.4a5.78,5.78,0,0,1,5.77-5.77h75a5.78,5.78,0,0,1,5.77,5.77V93.07A8.66,8.66,0,0,1,96.6,101.72ZM24.52,35.4V93.07A2.88,2.88,0,0,0,27.4,96H96.6a2.88,2.88,0,0,0,2.88-2.88V35.4Z"></path>
		<path className="cls-1"
			  d="M41.82,41.17a2.89,2.89,0,0,1-2.89-2.89V21a2.89,2.89,0,0,1,5.77,0v17.3A2.88,2.88,0,0,1,41.82,41.17Z"></path>
		<path className="cls-1"
			  d="M82.18,41.17a2.88,2.88,0,0,1-2.88-2.89V21a2.89,2.89,0,0,1,5.77,0v17.3A2.89,2.89,0,0,1,82.18,41.17Z"></path>
		<path className="cls-1" d="M102.37,49.82H21.63a1.45,1.45,0,0,1,0-2.89h80.74a1.45,1.45,0,0,1,0,2.89Z"></path>
		<path className="cls-1"
