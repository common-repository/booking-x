...
function bkx_process_mail_by_status( $booking_id, $subject, $content, $email = null, $is_customer = false ) {
	...
	$subject = str_replace( '{total_price}', $currency . $order_meta['total_price'], $subject );
	...
	$message_body = str_replace( '{total_price}', $currency . $order_meta['total_price'], $message_body );
