<?php
/**
 * BookingX Core BookingX Seat Post Type and Meta Box Class.
 *
...
if ( ! class_exists( 'BkxSeatMetaBox' ) ) {
	...
	class BkxSeatMetaBox {
		...
		public function bkx_seat_render_meta_box_content( $post ) {
			...
			$selected         = ! empty( $bkx_business_days ) ? count( $bkx_business_days ) : 2;
			...
			<input type="hidden" id="current_value" value="<?php echo esc_attr( $selected ); ?>">
			...
			<p>
				<label for="seat_is_different_loc"><strong><?php printf( esc_html__( 'Is %1$s at a different location ? ', 'bookingx' ), esc_html( $alias_seat ) ); ?>
						:</strong></label></p>
			<p><input type="radio" name="seat_is_different_loc" value="Y" 
			<?php
			if ( $seat_is_different_loc == 'Y' ) {
				echo "checked='checked'";
			}
			?>
				/>Yes
				<input type="radio" name="seat_is_different_loc" value="N" 
			<?php
			if ( $seat_is_different_loc == 'N' ) {
				echo "checked='checked'";
			}
			?>
			...
			<div class="seat_is_different_loc" style="<?php echo esc_attr( $display_location ); ?>">
			...
			?>
				 />Yes
				<input type="radio" name="seat_is_certain_month" value="N" 
			<?php
			if ( $seat_is_certain_month == 'N' ) {
				echo "checked='checked'";
			}
			?>
				
			<?php
			if ( $seat_is_certain_month == '' ) {
				echo "checked='checked'";
			}
			?>
				/>No</p>
			...
			<div id="certain_month">
				...
				<ul class="gfield_checkbox" id="input_1_16">
					...
					<li class="bkx_choice_16_1">
						<input name="seat_certain_month[]" class="month_checkbox" type="checkbox" value="January" id="choice_16_1" tabindex="31"
			<?php
			if ( isset( $temp_seat_months ) && ( $temp_seat_months != '' ) ) {
				if ( in_array( 'January', $temp_seat_months, true ) ) {
					 echo "checked='checked'";
				}
			}
			?>
					...
					<li class="bkx_choice_16_2">
						<input name="seat_certain_month[]" class="month_checkbox" type="checkbox" value="February" id="choice_16_2" tabindex="32"
			 <?php
				if ( isset( $temp_seat_months ) && ( $temp_seat_months != '' ) ) {
					if ( in_array( 'February', $temp_seat_months, true ) ) {
						  echo "checked='checked'";
					}
				}
				?>
					...
					<li class="bkx_choice_16_3">
						<input name="seat_certain_month[]" class="month_checkbox" type="checkbox" value="March" id="choice_16_3" tabindex="33"
			 <?php
				if ( isset( $temp_seat_months ) && ( $temp_seat_months != '' ) ) {
				...
				?>
					...
					<li class="bkx_choice_16_4">
						<input name="seat_certain_month[]" class="month_checkbox" type="checkbox" value="April" id="choice_16_4" tabindex="34"
							   <?php
								if ( isset( $temp_seat_months ) && ( $temp_seat_months != '' ) ) {
			...
			<p>
			<?php
			// translators:  Seat available at set days and times.
			printf( esc_html__( 'Will %1$s be available at set days and times', 'bookingx' ), esc_html( $alias_seat ) );
			?>
				</p>
			<div class="plugin-description">
				<input type="radio" name="seat_is_certain_day" value="Y" 
			<?php
			...
			?>
				 />Yes
				<input type="radio" name="seat_is_certain_day" value="N" 
			<?php
			if ( $seat_is_certain_day == 'N' ) {
				echo "checked='checked'";
			}
			?>
			<?php
			if ( $seat_is_certain_day == '' ) {
				echo "checked='checked'";
			}
			?>
				 />No
			...
			<?php echo bkx_generate_days_section( 7, $bkx_business_days ); // phpcs:ignore WordPress.Security.EscapeOutput ?>
						<li class="standard" id="add_more_days" style="<?php echo $add_more_status; // phpcs:ignore WordPress.Security.EscapeOutput ?>;">
			...
			?>
			<p><?php printf( esc_html__( 'Will the %1$s booking require pre payment : ', 'bookingx' ), esc_html( $alias_seat ) ); ?></p>
			<div class="plugin-description">
				<input type="radio" name="seat_is_pre_payment"
					   value="Y" 
			<?php
			if ( isset( $seat_is_pre_payment ) && ( $seat_is_pre_payment != '' ) ) {
			...
			<?php
			if ( isset( $seat_payment_type ) && ( $seat_payment_type != '' ) ) {
			...
			<?php
			if ( isset( $seat_deposite_type ) && ( $seat_deposite_type != '' ) ) {
			...
			<div id="fixedamount">
				...
				<div class="plugin-description">
					<input type="text" name="seat_amount"
						   value="
						   <?php
							if ( isset( $seat_fixed_amount ) && ( $seat_fixed_amount != '' ) ) {
										echo esc_attr( $seat_fixed_amount );
							}
							?>
						   ">
				</div>
			...
			<div id="percentage">
				...
				<div class="plugin-description">
					<input type="text" name="seat_percentage"
						   value="
						   <?php
							if ( isset( $seat_percentage ) && ( $seat_percentage != '' ) ) {
										echo esc_html( $seat_percentage );
							}
							?>
						   ">
				</div>
			...
			if ( ! empty( $associate_with_username ) ) {
				...
				if ( ! empty( $associate_with_username_obj ) && ! is_wp_error( $associate_with_username_obj ) ) {
					  // Translators: $s Linked with User.
                      printf( __( 'This Profile Link to %s <a href="%s"> view profile </a>', 'bookingx' ), $associate_with_username_obj->data->display_name, get_edit_user_link( $associate_with_username ) ); //phpcs:ignore
				...
				if ( ! empty( $associate_with_email ) && ! is_wp_error( $associate_with_email ) ) {
					// Translators: $s Linked with User.
                  printf( __( 'This Profile Link to %s <a href="%s"> view profile </a>', 'bookingx' ), $associate_with_email->data->display_name, get_edit_user_link( $associate_with_email->data->ID ) ); //phpcs:ignore
					$mannual      = 'display:none';
					$hide_related = 'display:block';
				}
			}
			if ( $bkx_user_auto == 'Y' ) {
				...
				if ( ! empty( $auto_user ) && ! is_wp_error( $auto_user ) ) {
					...
					// Translators: $s Linked with User.
             printf( __( 'This Profile Link to %s <a href="%s"> view profile </a>', 'bookingx' ), $auto_user->data->display_name, get_edit_user_link( $auto_user->data->ID ) ); //phpcs:ignore
					$mannual      = 'display:none';
					$hide_related = 'display:block';
				}
			}
			...
			?>
			<div class="bkx_user_mannual" style="<?php echo esc_attr( $mannual ); ?>">
				<p><?php printf( esc_html__( 'Do you want to associate this %1$s with a user ? : ', 'bookingx' ), esc_html( $alias_seat ) ); ?></p>
				<select name="associate_with_user" id="selOpt">
					<option value="N" 
			<?php
			if ( isset( $associate_with_user ) && ( $associate_with_user == 'N' ) ) {
				echo "selected='selected'";
			}
			?>
					...
					<option value="Y" 
			<?php
			if ( isset( $associate_with_user ) && ( $associate_with_user == 'Y' ) ) {
				echo "selected='selected'";
			}
			?>
				...
				<div class="active" id="selRoles" style="<?php echo esc_attr( $crete_user_auto_status ); ?>">
			...
			foreach ( $roles as $key => $role ) {
				...
				<?php
				if ( isset( $associate_with_user_role ) && ( $associate_with_user_role == $key ) ) {
					echo "selected='selected'";
				}
				?>
			...
			<?php } ?>
				...
				<div class="active" id="selUsers" style="
			<?php
				...
				"> <?php esc_html_e( 'Please select user :', 'bookingx' ); ?>
					<div class="plugin-description">
						<select id="users" class="bkx-associate-user" name="associate_with_username">
							<option value="<?php echo esc_attr( $associate_with_username ); ?>"><?php echo esc_html( $associate_with_username ); ?></option>
						</select>
					</div>
				</div>
			</div>
			<div class="bkx-seat-notification" style="<?php echo esc_attr( $hide_related ); ?>">
				<p><strong><?php esc_html_e( 'Notification Details', 'bookingx' ); ?></strong></p>
				<p><?php esc_html_e( 'Phone :', 'bookingx' ); ?></p>
			<?php $seat_phone = isset( $seat_phone ) && ( $seat_phone != '' ) ? $seat_phone : ''; ?>
				<p><input type="text" name="seat_phone" id="id_seat_phone" value="<?php echo esc_attr( $seat_phone ); ?>"/></p>
				<p><?php esc_html_e( 'Email :', 'bookingx' ); ?></p>
			<?php
			$seat_notification_email = isset( $seat_notification_email ) && ( $seat_notification_email != '' ) ? $seat_notification_email : '';
			?>
				<p><input type="text" name="seat_email" id="id_seat_email" value="<?php echo esc_attr( $seat_notification_email ); ?>"/></p>
				<p><input name="seat_is_alternate_email" type="checkbox" onclick="display_secondary_email(this);" value="Yes" id="id_seat_is_alternate_email" tabindex="83"
			<?php
			if ( isset( $seat_notification_alternate_email ) && ( $seat_notification_alternate_email != '' ) ) {
				echo "checked='checked'";
			}
			?>
			...
			<?php esc_html_e( 'Secondary Email :', 'bookingx' ); ?>
					<div class="plugin-description">
			<?php $seatAlternateEmail = isset( $seat_notification_alternate_email ) && ( $seat_notification_alternate_email != '' ) ? $seat_notification_alternate_email : ''; ?>
						<input type="text" name="seat_alternate_email" id="id_seat_alternate_email" value="<?php echo esc_attr( $seatAlternateEmail ); ?>"/>
					</div>
				</div>
				<p><input name="seat_is_ical" type="checkbox" onclick="display_ical_address(this);" value="Yes" id="id_seat_is_ical" tabindex="83"
			<?php
			if ( isset( $seat_ical_address ) && ( $seat_ical_address != '' ) ) {
				echo "checked='checked'";
			}
			?>
					 >
			...
			<?php esc_html_e( 'Google Calendar ID :', 'bookingx' ); ?>
					<div class="plugin-description">
			<?php $seatIcalAddress = isset( $seatIcalAddress ) && ( $seatIcalAddress != '' ) ? $seatIcalAddress : ''; ?>
						<input name="seat_ical_address" type="text" value="<?php echo esc_attr( $seatIcalAddress ); ?>" id="id_seat_ical_address" size="60">
					</div>
				</div>
			</div>
			<input type="hidden" name="is_user_valid" id="id_is_user_valid">
			<input type="hidden" name="seat_alias" id="seat_alias" value="<?php echo esc_attr( $alias_seat ); ?>">
			<?php
		}
		...
		public function save_bkx_seat_metaboxes( $post_id, $post, $update = null ) {
			...
			if ( isset( $_POST['seat_certain_day'] ) ) {
				$seatCertainDay = sanitize_text_field( wp_unslash( $_POST['seat_certain_day'] ) );
			}
			if ( isset( $_POST['seat_is_pre_payment'] ) ) {
				$seatIsPrePayment = sanitize_text_field( wp_unslash( $_POST['seat_is_pre_payment'] ) );
			}
			if ( isset( $_POST['seat_deposit_full'] ) ) {
				$seatDepositFull = sanitize_text_field( wp_unslash( $_POST['seat_deposit_full'] ) );
			}
			if ( isset( $_POST['seat_payment_option'] ) ) {
				$seatPaymentOption = sanitize_text_field( wp_unslash( $_POST['seat_payment_option'] ) );
			}
			if ( isset( $_POST['seat_amount'] ) ) {
				$seat_amount = sanitize_text_field( wp_unslash( $_POST['seat_amount'] ) );
			}
			if ( isset( $_POST['seat_percentage'] ) ) {
				$seat_percentage = sanitize_text_field( wp_unslash( $_POST['seat_percentage'] ) );
			}
			if ( isset( $_POST['seat_phone'] ) ) {
				$seatPhone = sanitize_text_field( wp_unslash( $_POST['seat_phone'] ) );
			}
			if ( isset( $_POST['seat_email'] ) ) {
				$seatEmail = sanitize_text_field( wp_unslash( $_POST['seat_email'] ) );
			}
			if ( isset( $_POST['seat_is_alternate_email'] ) ) {
				$seatIsAlternateEmail = sanitize_text_field( wp_unslash( $_POST['seat_is_alternate_email'] ) );
			}
			if ( isset( $_POST['seat_alternate_email'] ) ) {
				$seatAlternateEmail = sanitize_text_field( wp_unslash( $_POST['seat_alternate_email'] ) );
			}
			if ( isset( $_POST['seat_is_ical'] ) ) {
				$seatIsIcal = sanitize_text_field( wp_unslash( $_POST['seat_is_ical'] ) );
			}
			if ( isset( $_POST['seat_ical_address'] ) ) {
				$seatIcalAddress = sanitize_text_field( wp_unslash( $_POST['seat_ical_address'] ) );
			}
			if ( isset( $_POST['associate_with_user'] ) ) {
				$associate_with_user = sanitize_text_field( wp_unslash( $_POST['associate_with_user'] ) );
			}

			if ( isset( $_POST['associate_with_user_role'] ) ) {
				$associate_with_user_role = sanitize_text_field( wp_unslash( $_POST['associate_with_user_role'] ) );
			}
			if ( isset( $_POST['associate_with_username'] ) ) {
				$associate_with_username = sanitize_text_field( wp_unslash( $_POST['associate_with_username'] ) );
			}
			if ( isset( $_POST['bkx_user_auto'] ) ) {
				$bkx_user_auto = sanitize_text_field( wp_unslash( $_POST['bkx_user_auto'] ) );
			}

			if ( isset( $_POST['seat_is_different_loc'] ) ) {
				$seat_is_different_loc = sanitize_text_field( wp_unslash( $_POST['seat_is_different_loc'] ) );
			}
			if ( isset( $_POST['seat_certain_day'] ) ) {
			...
			if ( $seatDepositFull == 'Deposit' ) {
				$tempDepositFull = 'D';
			} elseif ( $seatDepositFull == 'Full Payment' ) {
				$tempDepositFull = 'FP';
			}
			...
			$remove_biz_days     = isset( $_POST['remove_biz_days'] ) ? sanitize_text_field( wp_unslash( $_POST['remove_biz_days'] ) ) : '';
			...
			for ( $d = 1; $d <= 7; $d++ ) {
				...
				if ( ! in_array( $d, $remove_biz_days_arr ) ) {
					if ( isset( $_POST[ 'opening_time_' . $d ] ) && ! empty( $_POST[ 'opening_time_' . $d ] ) && ! empty( $_POST[ 'days_' . $d ] ) ) {
						$selected_days[ 'selected_days_' . $d ]['time']['open']    = sanitize_text_field( wp_unslash( $_POST[ 'opening_time_' . $d ] ) );
						$seat_days_time_data[ 'selected_days_' . $d ]['time_from'] = sanitize_text_field( wp_unslash( $_POST[ 'opening_time_' . $d ] ) );
					}
					if ( isset( $_POST[ 'closing_time_' . $d ] ) && ! empty( $_POST[ 'closing_time_' . $d ] ) && ! empty( $_POST[ 'days_' . $d ] ) ) {
						$selected_days[ 'selected_days_' . $d ]['time']['close']   = sanitize_text_field( wp_unslash( $_POST[ 'closing_time_' . $d ] ) );
						$seat_days_time_data[ 'selected_days_' . $d ]['time_till'] = sanitize_text_field( wp_unslash( $_POST[ 'closing_time_' . $d ] ) );
					}
				}
			}
			...
			if ( isset( $_POST['seat_street'] ) ) {
				update_post_meta( $post_id, 'seat_street', sanitize_text_field( wp_unslash( $_POST['seat_street'] ) ) );
			}
			if ( isset( $_POST['seat_city'] ) ) {
				update_post_meta( $post_id, 'seat_city', sanitize_text_field( wp_unslash( $_POST['seat_city'] ) ) );
			}
			if ( isset( $_POST['seat_state'] ) ) {
				update_post_meta( $post_id, 'seat_state', sanitize_text_field( wp_unslash( $_POST['seat_state'] ) ) );
			}
			if ( isset( $_POST['seat_zip'] ) ) {
				update_post_meta( $post_id, 'seat_zip', sanitize_text_field( wp_unslash( $_POST['seat_zip'] ) ) );
			}
			if ( isset( $_POST['seat_country'] ) ) {
				update_post_meta( $post_id, 'seat_country', sanitize_text_field( wp_unslash( $_POST['seat_country'] ) ) );
			}
			if ( isset( $_POST['seat_city'] ) ) {
				update_post_meta( $post_id, 'seat_city', sanitize_text_field( wp_unslash( $_POST['seat_city'] ) ) );
			}
			if ( isset( $_POST['seat_is_certain_month'] ) ) {
				update_post_meta( $post_id, 'seat_is_certain_month', sanitize_text_field( wp_unslash( $_POST['seat_is_certain_month'] ) ) );
			}
			if ( isset( $seatCertainMonth ) ) {
				update_post_meta( $post_id, 'seat_months', sanitize_text_field( wp_unslash( $seatCertainMonth ) ) );
			}
			if ( isset( $_POST['seat_is_certain_day'] ) ) {
				update_post_meta( $post_id, 'seat_is_certain_day', sanitize_text_field( wp_unslash( $_POST['seat_is_certain_day'] ) ) );
			}
			...
			if ( isset( $bkx_user_id ) && $bkx_user_id != '' ) {
				...
				if ( isset( $_POST['seat_street'] ) ) {
					update_user_meta( $bkx_user_id, 'seat_street', sanitize_text_field( wp_unslash( $_POST['seat_street'] ) ) );
				}
				if ( isset( $_POST['seat_city'] ) ) {
					update_user_meta( $bkx_user_id, 'seat_city', sanitize_text_field( wp_unslash( $_POST['seat_city'] ) ) );
				}
				if ( isset( $_POST['seat_state'] ) ) {
					update_user_meta( $bkx_user_id, 'seat_state', sanitize_text_field( wp_unslash( $_POST['seat_state'] ) ) );
				}
				if ( isset( $_POST['seat_zip'] ) ) {
					update_user_meta( $bkx_user_id, 'seat_zip', sanitize_text_field( wp_unslash( $_POST['seat_zip'] ) ) );
				}
				if ( isset( $_POST['seat_country'] ) ) {
					update_user_meta( $bkx_user_id, 'seat_country', sanitize_text_field( wp_unslash( $_POST['seat_country'] ) ) );
				}
				if ( isset( $_POST['seat_city'] ) ) {
					update_user_meta( $bkx_user_id, 'seat_city', sanitize_text_field( wp_unslash( $_POST['seat_city'] ) ) );
				}
				if ( isset( $_POST['seat_is_certain_month'] ) ) {
					update_user_meta( $bkx_user_id, 'seat_is_certain_month', sanitize_text_field( wp_unslash( $_POST['seat_is_certain_month'] ) ) );
				}
				if ( isset( $seatCertainMonth ) ) {
					update_user_meta( $bkx_user_id, 'seat_months', sanitize_text_field( wp_unslash( $seatCertainMonth ) ) );
				}
				if ( isset( $_POST['seat_is_certain_day'] ) ) {
					update_user_meta( $bkx_user_id, 'seat_is_certain_day', sanitize_text_field( wp_unslash( $_POST['seat_is_certain_day'] ) ) );
				}
				if ( isset( $seatCertainDay ) ) {
		...
		public function bkx_seat_columns_content( $column_name, $post_ID ) {
			...
			if ( $column_name == 'any_seat' && isset( $enable_any_seat ) && $enable_any_seat == 1 ) :
				...
				echo '<a href="' . esc_url( $url ) . '" title="' . esc_attr__( 'Set as any Seat', 'bookingx' ) . '">';
				if ( $_enable_any_seat_id == $post_ID ) {
					echo '<span class="bks-any-seat tips" data-tip="' . esc_attr__( 'Yes', 'bookingx' ) . '">' . esc_attr__( 'Yes', 'bookingx' ) . '</span>';
				} else {
					echo '<span class="bks-any-seat not-any-seat tips" data-tip="' . esc_attr__( 'No', 'bookingx' ) . '">' . esc_attr__( 'No', 'bookingx' ) . '</span>';
				}
				echo '</a>';
			endif;

			if ( $column_name == 'display_shortcode_all' ) {
				echo '[bookingx seat-id="' . esc_attr( $post_ID ) . '" description="yes" image="yes" extra-info="no"]';
			}
		}
	}
}
