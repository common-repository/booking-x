...
class BkxExport {
	...
	public function settings_fields() {
		$options = array(
			'bkx_api_paypal_paypalmode',
			'bkx_api_paypal_username',
			'bkx_api_paypal_password',
			'bkx_api_paypal_signature',
			'bkx_gateway_paypal_express_status',
			'bkx_new_booking_enabled',
			'bkx_dashboard_column',
			'enable_cancel_booking',
			'cancellation_policy_page_id',
			'enable_any_seat',
			'bkx_enable_customer_dashboard',
			'currency_option',
			'bkx_seat_role',
			'bkx_alias_seat',
			'bkx_alias_base',
			'bkx_alias_addition',
			'bkx_alias_notification',
			'bkx_notice_time_extended_text_alias',
			'bkx_label_of_step1',
			'bkx_seat_taxonomy_status',
			'bkx_base_taxonomy_status',
			'bkx_addition_taxonomy_status',
			'bkx_legal_options',
			'bkx_term_cond_page',
			'bkx_cancellation_policy_page',
			'bkx_privacy_policy_page',
			'enable_editor',
			'bkx_set_booking_page',
			'bkx_siteuser_canedit_seat',
			'bkx_siteclient_canedit_css',
			'bkx_booking_style',
			'bkx_form_text_color',
			'bkx_active_step_color',
			'bkx_cal_day_color',
			'bkx_cal_day_selected_color',
			'bkx_time_available_color',
			'bkx_time_selected_color',
			'bkx_time_unavailable_color',
			'bkx_next_btn',
			'bkx_prev_btn',
			'bkx_business_name',
			'bkx_business_email',
			'bkx_business_phone',
			'bkx_business_address_1',
			'bkx_business_address_2',
			'bkx_business_city',
			'bkx_business_state',
			'bkx_business_zip',
			'bkx_business_country',
			'bkx_business_days',
			'bkx_biz_vac_sd',
			'bkx_biz_vac_ed',
			'bkx_biz_pub_holiday',
			'bkx_tax_rate',
			'bkx_tax_name',
			'bkx_prices_include_tax',
			'bkx_customer_cancelled_booking_subject',
			'bkx_customer_cancelled_booking_heading',
			'bkx_customer_cancelled_booking_additional_content',
			'bkx_customer_cancelled_booking_email_type',
			'bkx_save_bkx_email_customer_cancelled_booking',
			'bkx_customer_completed_booking_subject',
			'bkx_customer_completed_booking_heading',
			'bkx_customer_completed_booking_additional_content',
			'bkx_customer_completed_booking_email_type',
			'bkx_save_bkx_email_customer_completed_booking',
			'bkx_customer_ack_booking_subject',
			'bkx_customer_ack_booking_heading',
			'bkx_customer_ack_booking_additional_content',
			'bkx_customer_ack_booking_email_type',
			'bkx_save_bkx_email_customer_ack_booking',
			'bkx_customer_pending_booking_enabled',
			'bkx_customer_pending_booking_subject',
			'bkx_customer_pending_booking_heading',
			'bkx_customer_pending_booking_additional_content',
			'bkx_customer_pending_booking_email_type',
			'bkx_save_bkx_email_customer_pending_booking',
			'bkx_cancelled_booking_enabled',
			'bkx_cancelled_booking_recipient',
			'bkx_cancelled_booking_subject',
			'bkx_cancelled_booking_heading',
			'bkx_cancelled_booking_additional_content',
			'bkx_cancelled_booking_email_type',
			'bkx_save_bkx_email_cancelled_booking',
			'bkx_customer_edit_booking_enabled',
			'bkx_customer_edit_booking_subject',
			'bkx_customer_edit_booking_heading',
			'bkx_customer_edit_booking_additional_content',
			'bkx_customer_edit_booking_email_type',
			'bkx_save_bkx_email_customer_edit_booking',
			'bkx_edit_booking_enabled',
			'bkx_edit_booking_recipient',
			'bkx_edit_booking_subject',
			'bkx_edit_booking_heading',
			'bkx_edit_booking_additional_content',
			'bkx_edit_booking_email_type',
			'bkx_save_bkx_email_edit_booking',
			'bkx_pending_booking_enabled',
			'bkx_pending_booking_recipient',
			'bkx_pending_booking_subject',
			'bkx_pending_booking_heading',
			'bkx_pending_booking_additional_content',
			'bkx_pending_booking_email_type',
			'bkx_save_bkx_email_pending_booking',
			'bkx_emails_settings',
			'bkx_setting_form_init',
		);
		...
		if ( ! empty( $get_posts ) ) {
			...
			foreach ( $get_posts as $post ) {
				...
				if ( $post_type == 'bkx_booking' ) {
					...
					$booking_note_data_json = wp_json_encode( $booking_note_data );
