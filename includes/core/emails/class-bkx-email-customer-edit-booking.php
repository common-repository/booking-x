<?php
/**
 * Class BKX_Email_Customer_Edit_Booking file
 */
...
if ( ! class_exists( 'BKX_Email_Customer_Edit_Booking' ) ) :
	 ...
	 */
	/**
	 * Class BKX_Email_Customer_Edit_Booking
	 */
	class BKX_Email_Customer_Edit_Booking extends BookingX_Email_Content {
		...
		public function __construct() {
			...
			$this->template_plain = 'emails/plain/customer-edit-booking.php';
...
<p>Please contact us on {business_phone} or edit your <a href="{booking_edit_url}">booking online</a>.</p>',
				'bookingx'
			);
		}
		...
		public function init_form_fields() {
			...
			$this->form_fields = array(
				'enabled'            => array(
					...
					'default'    => 'yes',
					'option_key' => 'bkx_customer_edit_booking_enabled',
				),
				'subject'            => array(
					...
					'default'     => '',
					'option_key'  => 'bkx_customer_edit_booking_subject',
				),
				'heading'            => array(
					...
					'default'     => '',
					'option_key'  => 'bkx_customer_edit_booking_heading',
				),
				'additional_content' => array(
					...
					'option_key'     => 'bkx_customer_edit_booking_additional_content',
				),
				'email_type'         => array(
					...
					'option_key'  => 'bkx_customer_edit_booking_email_type',
				),
			);
		}
	}
...
return new BKX_Email_Customer_Edit_Booking();
