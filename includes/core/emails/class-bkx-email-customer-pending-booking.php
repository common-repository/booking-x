...
if ( ! class_exists( 'BKX_Email_Customer_Pending_Booking' ) ) :
	 ...
	 */
	class BKX_Email_Customer_Pending_Booking extends BookingX_Email_Content {
		...
		public function init_form_fields() {
			...
			$this->form_fields = array(
				'enabled'            => array(
					...
					'default'    => 'yes',
					'option_key' => 'bkx_customer_pending_booking_enabled',
				),
				'subject'            => array(
					...
					'default'     => '',
					'option_key'  => 'bkx_customer_pending_booking_subject',
				),
				'heading'            => array(
					...
					'default'     => '',
					'option_key'  => 'bkx_customer_pending_booking_heading',
				),
				'additional_content' => array(
					...
					'option_key'     => 'bkx_customer_pending_booking_additional_content',
				),
				'email_type'         => array(
					...
					'option_key'  => 'bkx_customer_pending_booking_email_type',
				),
			);
		}
	}
...
return new BKX_Email_Customer_Pending_Booking();
