...
class BookingX_Email_Content {
	...
	public function get_default_additional_content() {
		...
		return __(
			'Thanks {fname} for booking {base_name},
	...
	public function admin_options() {
		echo '<table class="form-table">' . $this->generate_settings_html( $this->get_form_fields(), false ) . '</table>'; // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped
	}
	...
	<tr valign="top">
		<th scope="row" class="titledesc">
			<label for="<?php echo esc_attr( $field_key ); ?>"><?php echo wp_kses_post( $data['title'] ); ?> <?php echo $this->get_tooltip_html( $data ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped ?></label>
		</th>
		<td class="forminp">
			<fieldset>
				<legend class="screen-reader-text"><span><?php echo wp_kses_post( $data['title'] ); ?></span></legend>
				<input class="input-text regular-input <?php echo esc_attr( $data['class'] ); ?>" type="<?php echo esc_attr( $data['type'] ); ?>" name="<?php echo esc_attr( $field_key ); ?>" id="<?php echo esc_attr( $field_key ); ?>" style="<?php echo esc_attr( $data['css'] ); ?>" value="<?php echo esc_attr( $this->get_option( $data['option_key'] ) ); ?>" placeholder="<?php echo esc_attr( $data['placeholder'] ); ?>" <?php disabled( $data['disabled'], true ); ?> <?php echo $this->get_custom_attribute_html( $data ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped ?> />
		<?php echo $this->get_description_html( $data ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped ?>
			</fieldset>
		</td>
	</tr>
		<?php
	...
	<tr valign="top">
		...
		<td class="forminp">
			<fieldset>
				<legend class="screen-reader-text"><span><?php echo wp_kses_post( $data['title'] ); ?></span></legend>
				<textarea rows="3" cols="20" class="input-text wide-input <?php echo esc_attr( $data['class'] ); ?>" type="<?php echo esc_attr( $data['type'] ); ?>" name="<?php echo esc_attr( $field_key ); ?>" id="<?php echo esc_attr( $field_key ); ?>" style="<?php echo esc_attr( $data['css'] ); ?>" placeholder="<?php echo esc_attr( $data['placeholder'] ); ?>" <?php disabled( $data['disabled'], true ); ?> <?php echo $this->get_custom_attribute_html( $data ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped ?>><?php echo esc_textarea( $this->get_option( $data['option_key'] ) ); ?></textarea>
		<?php echo $this->get_description_html( $data ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped ?>
			</fieldset>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td class="forminp">
			<fieldset>
				...
				<input <?php disabled( $data['disabled'], true ); ?> class="<?php echo esc_attr( $data['class'] ); ?>" type="checkbox" name="<?php echo esc_attr( $field_key ); ?>" id="<?php echo esc_attr( $field_key ); ?>" style="<?php echo esc_attr( $data['css'] ); ?>" value="1" <?php checked( $checkbox_value, 'yes' ); ?> <?php echo $this->get_custom_attribute_html( $data ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped ?> /> <?php echo wp_kses_post( $data['label'] ); ?></label><br/>
		<?php echo $this->get_description_html( $data ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped ?>
			</fieldset>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td class="forminp">
			<fieldset>
				<legend class="screen-reader-text"><span><?php echo wp_kses_post( $data['title'] ); ?></span></legend>
				<select class="select <?php echo esc_attr( $data['class'] ); ?>" name="<?php echo esc_attr( $field_key ); ?>" id="<?php echo esc_attr( $field_key ); ?>" style="<?php echo esc_attr( $data['css'] ); ?>" <?php disabled( $data['disabled'], true ); ?> <?php echo $this->get_custom_attribute_html( $data ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped ?>>
	...
	<tr valign="top">
		...
		<td class="forminp">
			<fieldset>
				<legend class="screen-reader-text"><span><?php echo wp_kses_post( $data['title'] ); ?></span></legend>
				<select multiple="multiple" class="multiselect <?php echo esc_attr( $data['class'] ); ?>" name="<?php echo esc_attr( $field_key ); ?>[]" id="<?php echo esc_attr( $field_key ); ?>" style="<?php echo esc_attr( $data['css'] ); ?>" <?php disabled( $data['disabled'], true ); ?> <?php echo $this->get_custom_attribute_html( $data ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped ?>>
		<?php foreach ( (array) $data['options'] as $option_key => $option_value ) : ?>
	...
	public function email_notification_setting() {
		$current_main_tab = isset( $_GET['bkx_tab'] ) ? sanitize_text_field( wp_unslash( $_GET['bkx_tab'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification
		$section          = isset( $_GET['section'] ) ? sanitize_text_field( wp_unslash( $_GET['section'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification
		$sub_tab          = isset( $_GET['sub_tab'] ) ? sanitize_text_field( wp_unslash( $_GET['sub_tab'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification
					...
					switch ( $key ) {
						case 'name':
							echo '<td class="bkx-email-settings-table-' . esc_attr( $key ) . '">
                                    ...
                                    </td>'; // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped
							break;
						case 'recipient':
							echo '<td class="bkx-email-settings-table-' . esc_attr( $key ) . '">
