...
jQuery( document ).on(
	...
	function (e) {
		...
		jQuery.each(
			jQuery( "input[name='seat_certain_day[]']" ),
			function (val) {
...
jQuery( document ).ready(
	function () {
		...
		jQuery( "#id_seat_colour" ).click(
			function () {
				jQuery( '.id_seat_colour' ).show();
			}
		);
		jQuery( ".id_seat_colour" ).mouseenter(
			function () {
				jQuery( '.id_seat_colour' ).show();
			}
		).mouseleave(
		...
		jQuery( "input[name='seat_certain_day[]']" ).change(
			function () {
				// alert("changing");
				if (this.checked === false) {
					var n       = jQuery( this ).attr( 'id' ).split( "_" );
		...
		jQuery( "input[name=seat_is_certain_time]:radio" ).bind(
			"change",
			function (event, ui) {
		...
		jQuery( "input[name=seat_is_pre_payment]:radio" ).bind(
			"change",
			function (event, ui) {
				// console.log('seat_is_certain_time: '+jQuery(this).val());
				if (jQuery( this ).val() == "Y") {
		...
		jQuery( "input[name=seat_is_alternate_time]:radio" ).bind(
			"change",
			function (event, ui) {
				// console.log('seat_is_certain_time: '+jQuery(this).val());
				if (jQuery( this ).val() == "Y") {
		...
		jQuery( "input[name=seat_is_certain_day]:radio" ).bind(
			"change",
			function (event, ui) {
				// console.log('seat_is_certain_time: '+jQuery(this).val());
				if (jQuery( this ).val() == "Y") {
		...
		jQuery( "input[name=seat_is_alternate_day]:radio" ).bind(
			"change",
			function (event, ui) {
				if (jQuery( this ).val() == "Y") {
					jQuery( "#alternate_day" ).show();
		...
		jQuery( "input[name=seat_is_certain_month]:radio" ).bind(
			"change",
			function (event, ui) {
				if (jQuery( this ).val() == "Y") {
					jQuery( "#certain_month" ).show();
		...
		jQuery( "input[name=seat_is_different_loc]:radio" ).bind(
			"change",
			function (event, ui) {
				// console.log('seat_is_certain_time: '+jQuery(this).val());
				if (jQuery( this ).val() == "Y") {
		...
		jQuery( "input[name=seat_is_alternate_month]:radio" ).bind(
			"change",
			function (event, ui) {
				// console.log('seat_is_certain_time: '+jQuery(this).val());
				if (jQuery( this ).val() == "Y") {
