<?php
/**
 * BookingX Dashboard Content Template Page
 *
...
<div class="col-sm-12">
	...
	<div class="tab-content" id="bkx-dashboard-tabContent">
		<div class="tab-pane fade show active" id="bkx-dashboard-bookings" role="tabpanel" aria-labelledby="bkx-dashboard-bookings-tab">
			<?php bkx_get_template( 'dashboard/listing.php' ); ?>
		</div>
		<div class="tab-pane fade" id="bkx-dashboard-my_account" role="tabpanel" aria-labelledby="bkx-dashboard-my_account-tab">
