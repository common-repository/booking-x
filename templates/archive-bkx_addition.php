<?php
/**
 * BookingX Archive Extra Listing Template Page
 *
...
do_action( 'bookingx_before_main_content' ); ?>
	<div class="booking-x-bkx-addition container">
		<?php if ( apply_filters( 'booking_x_show_page_title', false ) ) : ?>
			<h1 class="booking-x-bkx-additions page-title h1"><?php booking_x_page_title(); ?></h1>
		<?php endif; ?>
		...
		<?php if ( have_posts() ) : ?>
			...
			while ( have_posts() ) :
				...
				*/
				include 'content-bkx_addition.php';
				// End the loop.
			endwhile;
			?>
			</div>
			...
			do_action( 'booking_x_no_bkx_addition_found' );
		endif;
		?>
	</div>
<?php
